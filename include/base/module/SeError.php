<?php
class SeError extends Exception {
...
//        $this->trace = $this->trace();
    ...
    static public function show($message = "", $code = 0, $errorFile = '', $errorLine = 0) {
        new SeError($message, $code, $errorFile, $errorLine);
    }
...
body{ background: #fff; font-family: \'微软雅黑\'; color: #333; font-size: 15px; }
img{ border: 0; }
...
<body>
<div class="error" style="width:90%;text-align:center;position:absolute;top:35%;">
<div style="width:auto;display:inline-block!important;display:inline;padding:0.8em;background:#5B5B5B;color:#fff;border-radius:8px;text-align:center;"><h1>' . $this->message . '</h1></div>';
//开启调试模式之后，显示详细信息
