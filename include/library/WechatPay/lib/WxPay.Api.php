...
class WxPayApi
{
	...
	public static function unifiedOrder($inputObj, $timeOut = 6)
	{
		...
		$inputObj->SetAppid(C("DB.WX_APPID"));//公众账号ID
		$inputObj->SetMch_id(C("DB.WX_MCHID"));//商户号
        ...
        writeLog(json_encode(self::xmlToArray($response)));
	...
	public static function notify()
	{
		...
		try {
            //记录订单信息
            //writeLog(json_encode(self::xmlToArray($xml)));
    ...
    {
        $url = 'https://api.mch.weixin.qq.com/mmpaymkttransfers/promotion/transfers'; //请求url
        $inputObj = new WxPayUnifiedOrder();
        foreach($params as $key=>$value){
            $inputObj->setValue($key,$value);
        }
