(function() {
	...
	Layer.prototype = {
		...
		bindEvent: function() {
			var sureDom = this.el.querySelectorAll('.select-sure');
			var closeDom = this.el.querySelectorAll('.select-close');
			var self = this;
		...
		initLayer: function() {
			...
			var all_html = [
				'<header class="iosselect-header">',
					...
					'<a href="javascript:void(0)" class="select-close">取消</a>',
					'<a href="javascript:void(0)" class="select-sure">确定</a>',
				'</header>',
			...
			this.closeBtnDom = this.iosSelectLayer.el.querySelector('.select-close');
			...
			this.selectBtnDom = this.iosSelectLayer.el.querySelector('.select-sure');
